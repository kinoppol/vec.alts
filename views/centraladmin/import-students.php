...
<p class="page-sub">
  ...
  เมื่อสำเร็จการศึกษาแล้วข้อมูลชุดเดิมจะกลายเป็นผู้สำเร็จการศึกษาโดยไม่ต้องกรอกใหม่
</p>
...
<?php else: ?>
  ...
  <div class="card card-lg" style="max-width:720px">
    ...
    <div id="student-transfer"
      ...
      <button type="button" class="btn btn-primary btn-lg" data-start
              data-confirm-title="เริ่มโอนข้อมูลนักเรียน?"
              data-confirm-ok="เริ่มโอนข้อมูล"
              data-confirm="ระบบจะดึงข้อมูลนักเรียนทั้งหมดจาก RMS ทีละชุดจนครบ&#10;ระหว่างนี้อย่าปิดหน้าจอจนกว่าจะเสร็จ">
  ...
  <div class="card card-lg" style="max-width:720px;margin-top:20px">
    ...
    <div id="group-transfer"
      ...
      <button type="button" class="btn btn-primary" data-group-start
              data-confirm-title="โอนข้อมูลกลุ่มเรียน?"
              data-confirm-ok="โอนกลุ่มเรียน"
              data-confirm="ระบบจะดึงกลุ่มเรียนจาก RMS แล้วจับคู่นักเรียนกับครูที่ปรึกษาให้อัตโนมัติ">
  ...
  <div class="card" style="max-width:720px;margin-top:20px">
    ...
    <p class="cell-dim" style="line-height:1.9">
      ...
      <b>รหัสนักศึกษา</b> และ <b>เลขบัตรประชาชน</b> เช่นเดียวกับผู้สำเร็จการศึกษา
    ...
    <p class="hint" style="margin-top:10px">
      ...
      <a href="<?php echo e(url('schooladmin/alumni')); ?>">ข้อมูลผู้สำเร็จการศึกษา</a>
