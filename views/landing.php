 ...
 */
$features = array(
    array('icon' => '📝', 'title' => 'ผู้สำเร็จการศึกษากรอกเอง',
        'desc' => 'เข้าระบบด้วยรหัสนักศึกษาเดิมและเลขบัตรประชาชน อัปเดตข้อมูลและสถานะปัจจุบันได้ทันที'),
    array('icon' => '👩‍🏫', 'title' => 'ครูกรอกแทนได้',
        'desc' => 'ครูที่ปรึกษากรอกข้อมูลแทนผู้สำเร็จการศึกษาที่ติดต่อได้ ลดปัญหาข้อมูลตกหล่น'),
    ...
    array('icon' => '🔐', 'title' => 'สิทธิ์ตามบทบาท',
        'desc' => 'กำหนดสิทธิ์ผู้ใช้งานตามบทบาท ตั้งแต่ผู้สำเร็จการศึกษาถึงผู้ดูแลระบบกลาง'),
    array('icon' => '📥', 'title' => 'นำเข้า-ส่งออกง่าย',
        'desc' => 'นำเข้าข้อมูลผู้สำเร็จการศึกษาจาก CSV และส่งออกรายงานเพื่อรายงานต้นสังกัด'),
);

$stats = array(
    array('value' => num($summary['active_schools']), 'label' => 'สถานศึกษาที่ใช้งาน'),
    array('value' => num($summary['alumni']), 'label' => 'ผู้สำเร็จการศึกษาในระบบ'),
...
<section class="hero" id="overview">
  <div>
    ...
    <p>แพลตฟอร์มกลางให้สถานศึกษาหลายแห่งติดตามภาวะการมีงานทำและการศึกษาต่อของผู้สำเร็จการศึกษา
       พร้อมแดชบอร์ดภาพรวมสำหรับผู้บริหาร</p>
    <div class="hero-actions">
      <a class="btn btn-primary btn-lg" href="<?php echo e(url('login')); ?>">เข้าสู่ระบบสำหรับผู้สำเร็จการศึกษา</a>
...
<section class="wrap" id="users" style="padding-top:8px;padding-bottom:72px">
  ...
  <div class="grid-3" style="gap:18px">
    <?php
    $roles = array(
        array('ผู้สำเร็จการศึกษา', 'เข้าระบบด้วยรหัสนักศึกษาและเลขบัตรประชาชน กรอกสถานะการทำงานหรือการศึกษาต่อของตนเอง'),
        array('ครูที่ปรึกษา', 'ดูรายชื่อผู้สำเร็จการศึกษาในความดูแล ติดตามผู้ที่ยังไม่อัปเดต และกรอกข้อมูลแทนได้'),
        array('ผู้บริหาร', 'ดูแดชบอร์ดภาวะการมีงานทำ แยกตามแผนก และเปรียบเทียบระหว่างปีการศึกษา'),
        array('ผู้ดูแลสถานศึกษา', 'จัดการผู้ใช้งาน สาขาวิชา และนำเข้าข้อมูลผู้สำเร็จการศึกษาของสถานศึกษาตนเอง'),
